...
public class FollowCardController {
    ...
    public void setData(Follow follow) throws IOException {


        username.setText(follow.getFollower());

        try {
            User user = getUserByEmail(follow.getFollower());
